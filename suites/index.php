...
<html lang="en">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="css/bootstraps.min.css" />
                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
					  ...
					  <li> <a href="login/login.php"><button class="btn btn-lg btn-light">Login</button></a></li>
                    </ul>
                  </div>
                </nav>
              </div>
			...
			<div class="col-md-6 col-lg-4 mb-5">
				<div class="hotel-room text-center">
				  ...
				  <div class="hotel-room-body">
					...
					<strong class="price"><?= number_format($row['price'], 0)."$"  ?> / per night </strong> <br>
          <strong class="capacity">Max capacity:<?= number_format($row['capacity'], 0)?></strong><br>
          <a href="login/login.php"  data-toggle="modal" data-target="#myModal<?= $row['id'] ?>" ><button type="button" class="btn btn-info">Book now</button></a>
				  </div>
				</div>
			</div>
			...
			<div class="modal fade" id="myModal<?= $row['id'] ?>" role="dialog">
				<div class="modal-dialog modal-lg">
				  <div class="modal-content">
					...
					<input type="hidden" name = "RoomtypeID" value = "<?= $row['id']?>">
						<div class="row">
							<div class="col-sm-6">
								<b><?php echo $row['remark'] ?></b>
							</div>
					...
					<div class="modal-footer">
					  <button type="submit"  name="book_roombtn" class="btn btn-info">Book</button>
